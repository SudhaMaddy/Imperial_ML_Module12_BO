...
print(X)
y = np.load("/home/sudhakarmadamala/Downloads/Initial_data_points_starter/initial_data/function_/initial_outputs.npy")
print(y)
...
x_user = np.array([0.073653,0.456823,0.216125,0.189332,0.423049,0.851392])
