...
# Load data
X = np.load("/home/sudhakarmadamala/Downloads/Initial_data_points_starter/initial_data/function_5/initial_inputs.npy")
print(X)
y = np.load("/home/sudhakarmadamala/Downloads/Initial_data_points_starter/initial_data/function_5/initial_outputs.npy")
print(y)
...
plot_pairwise_projections(X, y, function_name="Function 5")
...
dim = X.shape[1]  # number of dimensions (4 for Function 4)
x_user = np.array([0.22, 0.85, 0.80, 0.90])


# -----------------------------
# GAUSSIAN PROCESS (BO MODEL)
# -----------------------------
kernel = C(1.0) * RBF(length_scale=0.4)
...
beta = 2.0  # exploration vs exploitation
