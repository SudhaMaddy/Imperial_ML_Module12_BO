...
# Load data
X = np.load("/home/sudhakarmadamala/Downloads/Initial_data_points_starter/initial_data/function_6/initial_inputs.npy")
print(X)
y = np.load("/home/sudhakarmadamala/Downloads/Initial_data_points_starter/initial_data/function_6/initial_outputs.npy")
print(y)
...
plot_pairwise_projections(X, y, function_name="Function 6")
...
x_user = np.array([0.224927,0.302504,0.431427,0.766288,0.080674])
